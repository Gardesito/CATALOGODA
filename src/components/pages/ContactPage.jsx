import { Camera, Leaf, Mail, MapPin, Phone, Users } from 'lucide-react'
export default function ContactPage() { return <div className="contact-page">
  <div className="logo-mark large"><Leaf /></div><span className="eyebrow">Gracias por elegirnos</span><h2>Hagamos crecer<br/>tu negocio.</h2><p>Consultanos por disponibilidad, entregas y condiciones mayoristas.</p>
